...
pip3 install --user torch==1.10.2+cu111 -i https://art-internal.hobot.cc/artifactory/api/pypi/pypi/simple ${pip_ext}
pip3 install --user torchvision==0.11.3+cu111 -i https://art-internal.hobot.cc/artifactory/api/pypi/pypi/simple ${pip_ext}
pip3 install --user torchaudio==0.10.2+cu111 -i https://art-internal.hobot.cc/artifactory/api/pypi/pypi/simple ${pip_ext}
pip3 install --use-deprecated=legacy-resolver --user -U -r requirements.txt ${pip_ext}

# internal requirements
pip3 install --user -U horizon-plugin-pytorch -f https://art-internal.hobot.cc/artifactory/custom-algo-pypi/horizon-plugin-pytorch/cu111/torch1102 --trusted-host art-internal.hobot.cc ${pip_ext}
...
pip3 install --user mmcv-full -f https://art-internal.hobot.cc/artifactory/custom-algo-pypi/mmcv/cu111/torch1100 ${pip_ext}
