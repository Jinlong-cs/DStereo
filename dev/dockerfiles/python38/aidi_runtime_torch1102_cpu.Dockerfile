...
# install pytorch
RUN pip3 install torch==1.10.2+cpu -i https://art-internal.hobot.cc/artifactory/api/pypi/pypi/simple && pip3 install torchvision==0.11.3+cpu -i https://art-internal.hobot.cc/artifactory/api/pypi/pypi/simple
RUN pip3 install torchaudio==0.10.2+cpu -i https://art-internal.hobot.cc/artifactory/api/pypi/pypi/simple
...
RUN pip3 install --no-cache-dir -U horizon-plugin-pytorch -f https://art-internal.hobot.cc/artifactory/custom-algo-pypi/horizon-plugin-pytorch/cpu/torch1102 --trusted-host art-internal.hobot.cc
