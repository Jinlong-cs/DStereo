# docker.hobot.cc/dlp/hat:runtime-py3.8-torch1.10.2-cu102-${COMMIT_ID:0:7}
# FROM docker.hobot.cc/imagesys/base:centos7.6-gcc5.4-py3.8-cuda10.2-horizon
FROM docker.hobot.cc/dlp/base:centos7.6-gcc5.4-py3.8-cuda10.2-horizon
