...
from hat.models.task_modules.dino.dino_transformer import (
    DINOTransformer,
...
@pytest.mark.skip
class TestDINOTransformer(HeadTemplate):
    def setup(self):
        super(TestDINOTransformer, self).setup()
        self.embed_dims = 64
        self.num_heads = 8
        ...
        self.model = DINOTransformer(
            ...
            num_feature_levels=4,
            num_proposals=self.num_queries,
