...
def submit(
    ...
    # TODO(mengyang.duan): watchdog can't monitor modified event of log file
    # due to permission
    # if monitor:
    #     monitor_cmd = "python3 watch_dog.py --log-path /job_log --pattern-files default_elastic_patterns.yaml"  # noqa E501
    #     thread = Thread(
    #         target=partial(run, exit_if_error=False), args=(monitor_cmd, None)  # noqa E501
    #     )
    #     thread.setDaemon(True)
    #     thread.start()
