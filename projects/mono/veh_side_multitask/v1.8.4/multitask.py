...
pretrain_ckpt = "http://fm-xiufeng-zhou.bcloud-2nd.hogpu.cc/plat_gpu/hobot-dag-3429671_veh-side-multitask-v1-8-1-20230717-102004/output/models/vehicle_side/float-checkpoint-last.pth.tar"
skip_float_stage = True
freeze_bn_pretrain_ckpt = pretrain_ckpt
skip_freeze_bn_stage = False
