...
pretrain_ckpt = "http://fm-xiufeng-zhou.bcloud-2nd.hogpu.cc/plat_gpu/veh_side_multitask-v1.0.3-20230512_104403/output/models/vehicle_side/float-checkpoint-last.pth.tar"
skip_float_stage = False
freeze_bn_pretrain_ckpt = None
...
suffix_cmds_on_master = [
    ...
    # f"python3 tools/deploy/compile_standalone.py {deploy_path} --input-size 1x3x192x960 --output /job_data/models/compile/ --opt O3 --march {march} --name real3d_with_desensitization --extra-args '--dev-remove-extra-output-cpu-op --max-time-per-fc 1000 --balance 10'",
]
