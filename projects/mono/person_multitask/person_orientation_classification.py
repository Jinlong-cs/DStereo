...
task_name = f"person_orientation_{task_type}"
divisor = 64
num_classes = 8
...
data_loader = dict(
    ...
    dataset=dict(
        ...
        category=range(1, num_classes + 1),  # category[dataset_index]
        to_rgb=False,
        ignore_hard=True,
...
val_data_loader = dict(
    ...
    dataset=dict(
        ...
        data_path=dataset_val_img_path[1],
        to_rgb=True,
...
nodes = {
    f"{task_name}_head": out_module,
    # f'{task_name}_neck': _neck
}
