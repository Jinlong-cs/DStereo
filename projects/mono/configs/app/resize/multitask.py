...
from models import march, model, test_model, traced_inputs, val_model  # noqa
...
batch_processor = dict(
    ...
    empty_cache=True,
    batch_transforms=train_gpu_transforms,
...
val_batch_processor["batch_transforms"] = None
...
aidi_expmodel_callback = dict(
    ...
    task_type="multitask",
    save_model="last",
    model_version=job_name + f"_{ctimestr}",
...
freeze_bn_callback = dict(
    type="FreezeModule",
    modules=[[backbone["node_name"], neck["node_name"]]],
