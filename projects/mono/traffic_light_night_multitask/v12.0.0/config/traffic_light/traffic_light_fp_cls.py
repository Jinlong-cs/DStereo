...
classnames = ["traffic_light_fp"]
object_type = "_".join(classnames)
task_name = f"{object_type}_{task_type}"
traffic_light_fp_sub_classnames = ["Positive", "Negative"]

# model
num_classes = len(traffic_light_fp_sub_classnames)
