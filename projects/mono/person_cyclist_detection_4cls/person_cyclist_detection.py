...
classnames = ["person_2PE", "cyclist_2PE", "motocyclist_2PE", "tricyclist_2PE"]
...
def get_model(mode, march):
    ...
    if march == March.BERNOULLI2:
        rpn_out_keys = ["pred_boxes_out", "pred_scores", "pred_cls"]  # j3
    else:
        rpn_out_keys = ["filter_coord", "filter_scores", "filter_bboxes"]  # j5
    ...
    model = dict(
        ...
        rpn_out_keys=rpn_out_keys if mode != "train" else None,
        rpn_module=dict(
            type="AnchorModule",
