...
# model
num_classes = len(traffic_light_dire_sub_classnames)
...
val_decoders[model_type] = (
    [task_name],
    dict(
        type="TLClsPredDecoder",
        model_name="traffic_light_mtl_hat",
...
ds = datapaths.traffic_light_dire
