...
work_condition_time_sub_classnames = ["Day", "Night", "Other"]

# model
num_classes = len(work_condition_time_sub_classnames)
...
val_decoders[model_type][1]["name_dict"].update(
    {task_name: work_condition_time_sub_classnames},
)
...
ds = datapaths.time_classification
