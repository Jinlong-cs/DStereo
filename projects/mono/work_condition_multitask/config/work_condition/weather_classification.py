...
work_condition_weather_sub_classnames = [
    "Sunny",
    "Cloudy",
    "Small_Rain",
    "Medium_Rain",
...
# model
num_classes = len(work_condition_weather_sub_classnames)
...
val_decoders[model_type][1]["name_dict"].update(
    {task_name: work_condition_weather_sub_classnames},
)
...
ds = datapaths.weather_classification
