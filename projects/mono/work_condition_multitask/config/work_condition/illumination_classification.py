...
from scene_classification import val_decoders

from hat.callbacks.metric_updater import update_metric_using_regex

task_type = "classification"
classnames = ["illumination"]
object_type = "_".join(classnames)
task_name = f"{object_type}_{task_type}"
work_condition_illumination_sub_classnames = [
    "natural_light",
    "lamplight",
    "Hard_Light",
    "dark",
...
# model
num_classes = len(work_condition_illumination_sub_classnames)
...
val_decoders[model_type][1]["name_dict"].update(
    {task_name: work_condition_illumination_sub_classnames},
)
...
ds = datapaths.illumination_classification
