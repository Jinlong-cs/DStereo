...
dst_label["wide_solid"] = 4
dst_label["deceleration_lane"] = 5
dst_label["tidal_lane"] = 1
dst_label["botts_dots"] = 1  # 增加点状线属性，merge为单线类别
...
# 颜色映射
# ===================================================
color_map = OrderedDict()  # 6 cls
color_map["road"] = [0, 0, 0]  # 黑色（道路 0）
color_map["dashed"] = [0, 0, 255]  # 蓝色（虚线 1）
color_map["Road_teeth"] = [0, 255, 0]  # 绿色（路沿 2）
color_map["double_line"] = [255, 255, 0]  # 黄色（双线 3）
color_map["wide_dashed"] = [153, 51, 204]  # 紫色（宽线 4）
color_map["deceleration_lane"] = [0, 255, 255]  # 青绿色（鱼骨线 5）
# lane parsing task 'other' class default is [255, 0, 0] #红色
...
src_label["botts_dots"] = 42  # 增加点状线属性
src_label["mask"] = 255
src_label["other"] = 255

dst_label["background"] = 255
src_label["background"] = 255
# src_label["botts_dots"] = 255
# dst_label["botts_dots"] = 255
