...
from auto_matrix.data.anno_transformer.seg.colormap import _parsing_colors
...
color_map_idx = OrderedDict()  # 16.2 cls
...
for key, value in color_map_idx.items():
    color_map[key] = _parsing_colors[value, 0, :]
