...
dataset_ids = dict(
    face_detection=[6034106],
    vehicle_plate_detection=[6037062],
)
...
int_infer_predictor = dict(
    ...
    model_convert_pipeline=dict(
        ...
        converters=[
            ...
            dict(
                type="LoadCheckpoint",
                checkpoint_path="http://fm-xiang-yan.bcloud-2nd.hogpu.cc/plat_gpu/hobot-dag-3411324_hat-superdrive-data-masking-20230714-141707/output/models/superdrive_data_masking/fuse_bn-checkpoint-last.pth.tar",  # noqa
                allow_miss=True,
                verbose=True,
            ),
