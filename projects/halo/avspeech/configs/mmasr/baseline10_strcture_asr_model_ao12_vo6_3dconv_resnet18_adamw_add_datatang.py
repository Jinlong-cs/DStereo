...
device_ids = cluster_device_ids if _in_cluster else [2]
...
#
# ------------------------------------------------------------------------
train_data_config = edict()

# 多模数据依赖路径
train_data_config.use_hisf = False
train_data_config.rir = f"{bucket}/J2MM/speech/hdf5/gpu_rirs/gpu_rirs.hdf5"
train_data_config.noise_info = f"{bucket}/J2MM/speech/hdf5/noise_info.txt"
train_data_config.noise_hdf5_file = f"{bucket}/J2MM/speech/hdf5/noise.hdf5"
train_data_config.augment_config_path = "projects/halo/avspeech/data/noise/exp_mmasr_augment_linearly_no_norm_low_snr.yaml"
train_data_config.info = f"{bucket}/J2MM/speech/hdf5/mmasr_info/train/train_fyz_j2mm_1000id_batch01-03_datatang.info"


train_dataset = get_train_dataset(config=train_data_config)
...
trainer_config.ao_pt = (
    f"/{bucket}/J2MM/speech/hdf5/mmasr_pretrain_model/avg_30_xingchen.pt"
)
trainer_config.vo_pt = f"/{bucket}/J2MM/speech/hdf5/mmasr_pretrain_model/exp0119_strcture_asr_model_vo6_3dconv_resnet18_adamw_float-checkpoint-average-min_wer-10-4962dd26.pth.tar"
...
float_trainer = dict(
    ...
    model_convert_pipeline=dict(
        ...
        converters=[
            dict(
                type="LoadCheckpoint",
                checkpoint_path=trainer_config.ao_pt,
                allow_miss=True,
            ...
            dict(
                type="LoadCheckpoint",
                checkpoint_path=trainer_config.vo_pt,
                allow_miss=True,
...
ckpt = "job_data/models/exp03013_strcture_asr_model_ao12_vo6_3dconv_resnet18_adamw_pretrain_both_adamw_addd_datatang_float-checkpoint-average-min_wer-30-058f6d57.pth.tar"
