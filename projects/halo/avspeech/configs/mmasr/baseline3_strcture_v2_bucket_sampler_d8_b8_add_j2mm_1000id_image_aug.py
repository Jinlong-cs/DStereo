...
from hat.models.task_modules.avspeech.mask import (
    ChunkMask,
    ChunkMaskV2,
    TargetMask,
)
...
if running_in_cluster():
    ...
    epoch_log_freq = 1
    step_log_freq = 100
    train_info_txt = os.path.join(
        data_root, "fyz_mmasr_chg/train_fyz_j2mm_1000id.info"
    )
    ...
    checkpoint_path = "/mnt/mnt-data-4/shujie.luo/Projects/HAT/job_data/models/mmasr_exp056_float-checkpoint-epoch-0062-4593876c.pth.tar"
...
float_predictor = dict(
    ...
    model_convert_pipeline=dict(
        ...
        converters=[
            dict(
                type="LoadCheckpoint",
                checkpoint_path="/mnt/mnt-data-4/shujie.luo/Projects/HAT/job_data/models/mmasr_j2mm_1000id_image_aug_finetune_float-checkpoint-epoch-0069-2a753168.pth.tar",
            ),
        ],
    ),
