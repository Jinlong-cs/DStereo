...
task_name = "sndr_mobilenext_cls_id1"
...
# SNDRMobileNeXt_1.0 for ImageNet 128.
# basic level latency (including head): 2897us.
# the head latency: ~175us
# backbone: ~2722us
# FLOPS: 118M * 2
# --------------------------------------------------------
model_v1 = dict(
...
# SNDRMobileNeXt_2.0 for ImageNet 128.
# basic level latency (including head): 2019us.
# the head latency: ~184us
# backbone: ~1835us
# FLOPS: 55M * 2
# --------------------------------------------------------
model_v2 = dict(
...
# SNDRMobileNeXt_3.0 for ImageNet 128.
# basic level latency (including head): 1780us.
# the head latency: ~169us
# backbone: ~1611us
# FLOPS: 44M * 2
# --------------------------------------------------------
model_v3 = dict(
    ...
    backbone=dict(
        ...
        num_classes=1000,
        bn_kwargs={},
        in_chls=[[32], [32], [32], [32], [64]],
        out_chls=[[32], [32], [32], [64], [128]],
        expand_ratio=2,
        feat_size=4,
    ),
    losses=dict(type="CEWithLabelSmooth"),
