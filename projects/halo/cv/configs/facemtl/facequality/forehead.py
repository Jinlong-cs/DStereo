...
train_data_loader = dict(
    ...
    sampler=dict(
        ...
        # expect_distribution={"0": 0.4, "1": 0.6}, # align
        expect_distribution={"0": 0.65, "1": 0.35},  # mixvargenet0.75
        # expect_distribution={"0": 0.55, "1": 0.45},    # finetune
        task_name=task_name,
