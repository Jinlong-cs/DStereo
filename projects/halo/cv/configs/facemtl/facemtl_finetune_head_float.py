...
float_freeze_callback = dict(
    type="FreezeModule",
    modules=[float_freeze_modules],
    step_or_epoch=[0],
    update_by="epoch",
...
float_callbacks += train_metric_updaters
float_callbacks = float_callbacks + [float_freeze_callback]
