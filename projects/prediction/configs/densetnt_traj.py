...
# Task configurations
task_name = "task_densetnt_master"
...
# 下方数据集需要修改配置：float_epoch, qat_epoch = 30, 5
# train_pkl_name = "small_fus_train"  # 100w 环境融合
# val_pkl_name = "small_fus_val"  # 20w 环境融合

# 下方数据集需要修改配置：float_epoch, qat_epoch = 20, 5
train_pkl_name = "fus_train_full_his6"  # 657w 环境融合 + 感知速度
val_pkl_name = "fus_val_full_his6"  # 44w 环境融合 + 感知速度
...
veh_range = [130.0, -50.0, 50.0, -50.0]
ped_range = [30.0, 0.0, 10.0, -10.0]
cyc_range = [130.0, -50.0, 20.0, -20.0]
