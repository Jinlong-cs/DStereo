...
train_pkl_name = "full_train"  # "full_scene_SH_train_pkl" for default
val_pkl_name = "full_val"  # "full_scene_SH_val_pkl" for default

# train_pkl_name = "densetnt_tiny_train"  # 3
# val_pkl_name = "densetnt_tiny_test"  # 1

# train_pkl_name = "fus_train"  # 融合数据训练集
# val_pkl_name = "fus_test"  # 融合数据测试集
...
veh_range = [130, -50, 50, -50]
ped_range = [30, 0, 10, -10]
cyc_range = [130, -50, 20, -20]
...
veh_lateral_drift_thr = 3.0  # if use set: 1.5
veh_type_id = 1
