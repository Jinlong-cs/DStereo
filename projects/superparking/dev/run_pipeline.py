...
HAT_BUCKET_PATH = "/horizon-bucket/HDLTAlgorithm"
...
def check_consistency(
    ...
    frcnn_model_split = str(int(pub_cfg.get("frcnn_split", False)))
    ...
    _cmd = f"""
    set -e
    sh {trigger_script} {sub_project} {frcnn_model_split} \
    ...
    jenkins_console_url = "https://haihui.chen:1111a9c180388f1f1d18a976424497a5d0@ci.hobot.cc/view/QA/job/QA-Auto/job/QA02_DEV/job/dev-pilot3-model-verifier/{}/console"  # noqa

    logger.info(
        f"Please check url for more information: {jenkins_console_url.format(job_id)}"  # noqa
    )
