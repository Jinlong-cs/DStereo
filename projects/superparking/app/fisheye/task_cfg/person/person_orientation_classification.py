...
task_name = f"{object_type}_orientation_{task_type}"
...
# ------------------------ dataloader ---------------------------
# data
ds = datapaths.person_orientation_classification
...
(
    ...
    old_prediction,
    new_prediction,
) = get_rcnn_aidi_eval_info("person_orientation_classification", "person")
