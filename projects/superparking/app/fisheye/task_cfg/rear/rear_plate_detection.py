...
(
    ...
    old_prediction,
    new_prediction,
) = get_rcnn_aidi_eval_info("rear_plate_detection", "rear")

aidi_eval_loader = get_2d_aidi_eval_loaders(
    batch_size["val"], "rear_plate_detection", infer_model_type="rcnn"
)
