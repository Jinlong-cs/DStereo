...
model_name = "cloudmodel_traffic_sign_euro_detection_swinbw_12_bifpn_fcos"
model_desc = ""
model_config = "projects/cloudmodel/model_service/model_configs/detection/singletask_traffic_sign_euro_detection_config.py"  # noqa
param_file = "/horizon-bucket/adas/big_model/model_zoo/singletask_traffic_sign_euro_mono_0912.pth.tar"  # noqa
# envs
