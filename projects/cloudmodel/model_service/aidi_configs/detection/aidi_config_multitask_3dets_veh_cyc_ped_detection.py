...
model_name = "cloudmodel_multitask_3dets_veh_cyc_ped_detection_csp_darknet_csp_pafpn_fcos"
model_desc = ""

model_config = "projects/cloudmodel/model_service/model_configs/detection/multitask_3dets_veh_cyc_ped_csp_darknet_csp_pafpn_fcos.py"
param_file = "/horizon-bucket/adas/fei01.he/big_model/big_model_checkpoint-4th-stage-T.pth.tar"  # noqa
# envs
