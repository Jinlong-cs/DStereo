...
model_name = "cloudmodel_singletask_adb_light_detection_swinb_w12_pafpn_fcos"
model_desc = ""
model_config = "projects/cloudmodel/model_service/model_configs/detection/singletask_adb_light_swinb_w12_pafpn_fcos.py"  # noqa
param_file = "/jfs-public/adas/haoyang.zhang/haoyang.zhang/model_zoo/adb_light_detection/big_model_checkpoint-step-62999.pth.tar"  # noqa
# envs
