...
model_name = "cloudmodel_rear_detection_swinbw_12_bifpn_fcos"
model_desc = ""
model_config = "projects/cloudmodel/model_service/model_configs/detection/singletask_rear_detection_config.py"  # noqa
param_file = "/horizon-bucket/adas/big_model/model_zoo/rear_detection_v1.0/big_model_checkpoint-last.pth.tar"  # noqa
# envs
