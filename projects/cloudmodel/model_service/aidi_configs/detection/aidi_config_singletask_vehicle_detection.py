...
model_name = "cloudmodel_vehicle_detection_swinbw_12_bifpn_fcos"
model_desc = ""
model_config = "projects/cloudmodel/model_service/model_configs/detection/singletask_vehicle_detection_config.py"  # noqa
param_file = "/horizon-bucket/adas/big_model/model_zoo/swin_singletask_model_ckpts/vehicle_no_cycle_20230427_113726.pth.tar"  # noqa
# envs
