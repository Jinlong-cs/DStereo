...
model_name = "cloudmodel_person_detection_swinbw_12_bifpn_fcos"
model_desc = ""
model_config = "projects/cloudmodel/model_service/model_configs/detection/singletask_person_detection.py"  # noqa
