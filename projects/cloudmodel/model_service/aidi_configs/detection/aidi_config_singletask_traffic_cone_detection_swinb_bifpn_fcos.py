...
model_desc = ""
model_name = "cloudmodel_singletask_traffic_cone_detection_swinb_bifpn_fcos"

model_config = "projects/cloudmodel/model_service/model_configs/detection/singletask_traffic_cone_detection_swinb_pifpn_fcos.py"  # noqa

param_file = "/horizon-bucket/adas/fei01.he/big_model/model_zoo/traffic_cone/big_model_checkpoint-last.pth.tar"  # noqa
