...
model_name = "cloudmodel_multitask_8dets_mmefficientnetb5_bifpn_fcos"
model_desc = ""
model_config = "projects/cloudmodel/model_service/model_configs/detection/multitask_8dets_mmefficientnetb5_bifpn_fcos.py"
param_file = "/horizon-bucket/adas/big_model/model_zoo/HAT_mmEfficientNetB5_BiFPN_FCOS_8Dets_checkpoint_20221116.pth.tar"  # noqa
# envs
