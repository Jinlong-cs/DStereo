...
model_name = "cloudmodel_traffic_cone_detection_swinbw_12_bifpn_fcos"
model_desc = ""
model_config = "projects/cloudmodel/model_service/model_configs/detection/singletask_traffic_cone_detection_config.py"  # noqa
param_file = "/horizon-bucket/adas/big_model/model_zoo/swin_singletask_model_ckpts/finetune_traffic_cone_15k-20230517_110535.pth.tar"  # noqa
# envs
