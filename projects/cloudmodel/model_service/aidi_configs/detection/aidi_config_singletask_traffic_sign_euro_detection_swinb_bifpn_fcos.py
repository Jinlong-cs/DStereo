...
model_desc = ""
model_name = (
    "cloudmodel_singletask_traffic_sign_euro_detection_swinb_bifpn_fcos"
)
...
param_file = "/horizon-bucket/adas/fei01.he/big_model/model_zoo/traffic_sign_eu/big_model_checkpoint-last.pth.tar"  # noqa
