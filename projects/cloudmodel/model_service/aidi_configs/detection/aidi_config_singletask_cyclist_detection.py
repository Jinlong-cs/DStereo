...
model_name = "cloudmodel_cyclist_detection_swinbw_12_bifpn_fcos"
model_desc = ""
model_config = "projects/cloudmodel/model_service/model_configs/detection/singletask_cyclist_detection.py"  # noqa
param_file = "/horizon-bucket/adas/big_model/model_zoo/swin_singletask_model_ckpts/person_cyclist_120k_20230704_123211.pth.tar"  # noqa
# envs
