...
model_desc = ""
model_name = (
    "cloudmodel_singletask_vehicle_wheel_detection_swinb_w12_bifpn_fcos"
)

model_config = "projects/cloudmodel/model_service/model_configs/detection/singletask_vehicle_wheel_detection_swinb_w12_pifpn_fcos.py"  # noqa

param_file = "/horizon-bucket/adas/fei01.he/big_model/model_zoo/vehicle_wheel/big_model_checkpoint-2nd-stage.pth.tar"  # noqa
