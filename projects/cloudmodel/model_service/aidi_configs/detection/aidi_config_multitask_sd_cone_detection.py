...
model_desc = ""
model_name = "cloudmodel_multitask_sd_cone_detection_swinb_bifpn_fcos"

model_config = "projects/cloudmodel/model_service/model_configs/detection/multitask_sd_cone_swinb_w12_bifpn_fcos.py"  # noqa

param_file = "/jfs-public/adas/haoyang.zhang/haoyang.zhang/model_zoo/sd_cone_5_classes/big_model_checkpoint-last.pth.tar"  # noqa
