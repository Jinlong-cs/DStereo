...
model_name = "cloudmodel_work_condition_RN50"
model_desc = ""
model_config = "projects/cloudmodel/model_service/model_configs/classification/multitask_work_condition_classification.py"
param_file = "/horizon-bucket/adas/big_model/model_zoo/work_condition/float-checkpoint-step-50499-4a7c2143.pth.tar"  # noqa
# envs
