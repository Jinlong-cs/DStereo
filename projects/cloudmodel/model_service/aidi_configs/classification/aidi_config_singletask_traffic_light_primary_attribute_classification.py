...
model_name = "cloudmodel_traffic_light_primary_attribute"
model_desc = ""
model_config = "projects/cloudmodel/model_service/model_configs/classification/singletask_traffic_light_primary_attribute_config.py"
param_file = "/horizon-bucket/adas/big_model/model_zoo/attribute_models/traffic_light_primary/big_model_checkpoint-step-79999.pth.tar"
# envs
