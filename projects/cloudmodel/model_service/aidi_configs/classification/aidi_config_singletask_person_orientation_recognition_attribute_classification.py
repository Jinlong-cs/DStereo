...
model_name = (
    "cloudmodel_person_orientation_recognition_attribute_classification"
)
model_desc = ""
model_config = "projects/cloudmodel/model_service/model_configs/classification/singletask_person_orientation_recognition_attribute_classification.py"
param_file = "/horizon-bucket/adas/lina.shen/models/person_orientation_recognition_attribute/big_model_checkpoint-step-189999.pth.tar"
# envs
