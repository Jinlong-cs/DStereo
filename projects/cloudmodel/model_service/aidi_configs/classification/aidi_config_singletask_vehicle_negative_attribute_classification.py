...
model_name = "cloudmodel_vehicle_negative_attribute_classification"
model_desc = ""
model_config = "projects/cloudmodel/model_service/model_configs/classification/singletask_vehicle_negative_attribute_classification.py"
param_file = "/horizon-bucket/adas/lina.shen/models/vehicle_negative_recognition/big_model_checkpoint-step-109999.pth.tar"
# envs
