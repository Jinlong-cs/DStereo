...
model_name = "cloudmodel_person_negative_attribute_classification"
model_desc = ""
model_config = "projects/cloudmodel/model_service/model_configs/classification/singletask_person_negative_attribute_classification.py"  # noqa
param_file = "/horizon-bucket/adas/lina.shen/models/person_negative_recognition/big_model_checkpoint-step-99999.pth.tar"
# envs
