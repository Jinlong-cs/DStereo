...
model_name = "cloudmodel_traffic_sign_medium_attribute"
model_desc = "标志牌分类模型"
model_config = "projects/cloudmodel/model_service/model_configs/classification/singletask_traffic_sign_medium_attribute_config.py"
param_file = "/horizon-bucket/adas/big_model/model_zoo/attribute_models/traffic_sign_medium/big_model_checkpoint-step-119999.pth.tar"
# envs
