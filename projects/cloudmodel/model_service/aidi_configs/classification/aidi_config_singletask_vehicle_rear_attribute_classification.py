...
model_name = "cloudmodel_vehicle_rear_attribute"
model_desc = ""
model_config = "projects/cloudmodel/model_service/model_configs/classification/singletask_vehicle_rear_attribute_classification.py"
param_file = "/horizon-bucket/adas/big_model/tmp/models/vehicle_rear_attribute/big_model_checkpoint-step-144999.pth.tar"
# envs
