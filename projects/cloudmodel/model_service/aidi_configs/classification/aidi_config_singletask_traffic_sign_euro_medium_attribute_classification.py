...
model_name = "cloudmodel_traffic_sign_euro_medium_attribute"
model_desc = "欧洲标志牌分类模型"
model_config = "projects/cloudmodel/model_service/model_configs/classification/singletask_traffic_sign_euro_medium_attribute_config.py"
param_file = "/horizon-bucket/adas/big_model/model_zoo/attribute_models/traffic_sign_gl_medium_attribute_classification/20230904-120357/big_model_checkpoint-step-64999.pth.tar"
# envs
