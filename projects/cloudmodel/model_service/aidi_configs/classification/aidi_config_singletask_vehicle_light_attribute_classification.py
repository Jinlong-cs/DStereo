...
model_name = "cloudmodel_vehicle_light_attribute"
model_desc = ""
model_config = "projects/cloudmodel/model_service/model_configs/classification/singletask_vehicle_light_attribute_classification.py"
param_file = "/horizon-bucket/adas/big_model/model_zoo/attribute_models/vehicle_light/big_model_checkpoint-step-159999.pth.tar"
# envs
