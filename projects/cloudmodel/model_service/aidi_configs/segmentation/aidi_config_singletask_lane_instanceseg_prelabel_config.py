...
model_name = "cloudmodel_lane_instanceseg_swins_bifpn_solov2_prelabel"
model_desc = ""
model_config = "projects/cloudmodel/model_service/model_configs/segmentation/singletask_lane_instanceseg_prelabel_config.py"
