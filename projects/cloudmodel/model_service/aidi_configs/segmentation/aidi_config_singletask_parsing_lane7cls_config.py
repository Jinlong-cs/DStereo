...
model_name = "cloudmodel_lane_parsing_7cls_segmentation"
model_desc = ""
model_config = "projects/cloudmodel/model_service/model_configs/segmentation/singletask_lane_parsing_7cls_config.py"
param_file = "/horizon-bucket/adas/big_model/model_zoo/SingleTask-lane7cls-hatswinb-bifpn-S200k-B8-R1280_1536-lr1e-5-Upscale2-Feat4816-dwSemFPN-FP32-W1-CE5Dice1V2loss-RemoveP.pth.tar"  # noqa
# envs
