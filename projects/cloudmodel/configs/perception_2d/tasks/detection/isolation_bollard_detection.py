...
from hat.data.collates.collates import collate_2d_replace_empty
...
# ------------------------------ task setting ------------------------------ #
task = AllTasks.isolation_bollard_detection
...
collate_2d_re = partial(collate_2d_replace_empty, prob=0.75)
