...
# ------------------------------ task setting ------------------------------ #
task = AllTasks.vehicle_rear_attribute_classification
task_name = task.task_name

task_loss_weight = 1.0

num_classes = 35
attr_type_list = ["type", "occlusion", "ignore", "confidence", "Orientation"]
attr_type_value = [19, 5, 2, 5, 4]
ignore_idx = [25]
confidence_idx = [28, 29]
occlusion_idx = [23]  # [22, 23] #
