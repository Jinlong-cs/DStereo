...
# ------------------------------ task setting ------------------------------ #
task = AllTasks.person_orientation_recognition_classification
task_name = task.task_name

task_loss_weight = 1.0

num_classes = 16  # sum([len(ii) for _,ii in name_dict.items()])
attr_type_list = ["orientation", "Towards", "logo"]
attr_type_value = [9, 2, 5]
ignore_idx = []
confidence_idx = []
occlusion_idx = []
