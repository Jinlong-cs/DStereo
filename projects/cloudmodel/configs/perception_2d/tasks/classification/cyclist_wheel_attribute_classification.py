...
# ------------------------------ task setting ------------------------------ #
task = AllTasks.cyclist_wheel_attribute_classification
task_name = task.task_name

task_loss_weight = 1.0

num_classes = 14
attr_type_list = ["wheel_order", "occlusion", "confidence", "self_occlusion"]
attr_type_value = [2, 4, 4, 4]
ignore_idx = []
confidence_idx = [9]
occlusion_idx = [5, 13]
...
name_dict = {
    "wheel_order": ["front_wheel", "back_wheel"],
    "occlusion": [
        "full_visible",
        "occluded",
        "heavily_occluded",
