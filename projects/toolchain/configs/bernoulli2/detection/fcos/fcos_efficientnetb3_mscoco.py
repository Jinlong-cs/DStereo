...
task_name = "fcos_efficientnetb3_mscoco"
num_classes = 80
...
model = dict(
    ...
    head=dict(
        ...
        out_strides=[8, 16, 32, 64, 128],
        stride2channels=dict({8: 120, 16: 120, 32: 120, 64: 120, 128: 120}),
...
deploy_inputs = dict(img=torch.randn((1, 3, 896, 896)))
