...
task_name = "efficientnasnetm_cls"
num_classes = 1000
batch_size_per_gpu = 64
device_ids = [0, 1, 2, 3, 4, 5, 6, 7]  # 4 nodes
...
model = dict(
    ...
    backbone=dict(
        ...
        bn_kwargs={},
        model_type="b0",
        coefficient_params=(1.0, 1.0, 300, 0.2),
        num_classes=1000,
        include_top=True,
        activation="relu",
        use_se_block=False,
...
deploy_inputs = dict(img=torch.randn((1, 3, 300, 300)))
...
val_data_loader = dict(
    ...
    dataset=dict(
        ...
        transforms=[
            ...
            dict(type="TorchVisionAdapter", interface="CenterCrop", size=300),
