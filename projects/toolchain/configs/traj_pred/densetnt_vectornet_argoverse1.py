...
deploy_model_convert_pipeline = int_infer_trainer["model_convert_pipeline"]
...
def process_inputs(infer_inputs, transforms=None):
    traj_feat = np.load(infer_inputs["traj_feat"])
    traj_mask = np.load(infer_inputs["traj_mask"])
    lane_feat = np.load(infer_inputs["lane_feat"])
    lane_mask = np.load(infer_inputs["lane_mask"])
    instance_mask = np.load(infer_inputs["instance_mask"])
    goals_2d = np.load(infer_inputs["goals_2d"])
    goals_2d_mask = np.load(infer_inputs["goals_2d_mask"])
    labels = np.load(infer_inputs["labels"])
    traj_feat_mask = np.load(infer_inputs["traj_feat_mask"])
    model_inputs = {
...
infer_cfg = dict(
    model=model,
    infer_inputs=dict(
        traj_feat="./tmp_orig_data/argoverse-1/infer_data/traj_feat.npy",
        traj_mask="./tmp_orig_data/argoverse-1/infer_data/traj_mask.npy",
        lane_feat="./tmp_orig_data/argoverse-1/infer_data/lane_feat.npy",
        lane_mask="./tmp_orig_data/argoverse-1/infer_data/lane_mask.npy",
        instance_mask="./tmp_orig_data/argoverse-1/infer_data/instance_mask.npy",
        goals_2d="./tmp_orig_data/argoverse-1/infer_data/goals_2d.npy",
        goals_2d_mask="./tmp_orig_data/argoverse-1/infer_data/goals_2d_mask.npy",
        labels="./tmp_orig_data/argoverse-1/infer_data/labels.npy",
        traj_feat_mask="./tmp_orig_data/argoverse-1/infer_data/traj_feat_mask.npy",
    ),
