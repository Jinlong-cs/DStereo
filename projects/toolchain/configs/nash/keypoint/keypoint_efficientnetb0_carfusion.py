...
deploy_model_convert_pipeline = dict(  # noqa: C408
    ...
    converters=[
        ...
        dict(type="QAT2Quantize", convert_mode=convert_mode),  # noqa: C408
    ],
)
...
def process_inputs(infer_inputs, transforms):
    ori_img = Image.open(infer_inputs["img"]).convert("RGB")
...
infer_cfg = dict(
    model=hbir_infer_model,
    infer_inputs=dict(
        img="./tmp_orig_data/carfusion/cropped_data/test/car_penn1/crop_imgs/16_20837_0.jpg",
    ),
