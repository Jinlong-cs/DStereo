...
task_name = "deeplabv3plus_efficientnetm0_cityscapes"
num_classes = 19
...
def process_inputs(infer_inputs, transforms):
    image = Image.open(infer_inputs["img"]).convert("RGB")
...
infer_cfg = dict(
    model=hbir_infer_model,
    infer_inputs=dict(
        img="./tmp_orig_data/cityscapes/leftImg8bit/val/frankfurt/frankfurt_000000_000294_leftImg8bit.png",
    ),
