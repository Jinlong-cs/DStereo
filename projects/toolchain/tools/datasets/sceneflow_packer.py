...
from hat.data.datasets.sceneflow_dataset import SceneFlowPacker
from hat.utils.logger import init_logger


def parse_args():
    parser = argparse.ArgumentParser(description="Pack SceneFlow Dataset.")
    parser.add_argument(
        "--src-data-dir",
        required=True,
...
if __name__ == "__main__":
    ...
    init_logger("work_dirs/hat_logss/SceneflowPacker")
