...
from hat.data.datasets.carfusion_keypoints_dataset import CarfusionPacker
from hat.utils.logger import init_logger


def parse_args():
    parser = argparse.ArgumentParser(description="Pack carfusion dataset.")
    parser.add_argument(
        "-s",
        "--src-data-dir",
        required=True,
...
if __name__ == "__main__":
    ...
    init_logger("work_dirs/hat_logss/carfusion_packer")
