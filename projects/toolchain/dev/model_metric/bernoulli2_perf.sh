...
cp -r tmp_orig_models/bernoulli2_release_models/ tmp_models
...
do
  sed -i 's/march = March.BAYES/march = March.BERNOULLI2/g' ${cfg}
...
tar -cvf model_zoo/bernoulli2_release_models.tar release_models
