...
#   echo ${net_name}
  ...
  cat work_dirs/hat_logss/${task_name}_align_bpu_validation.log | awk 'END {print}'| awk 'BEGIN { FS = "Validation "} ; {print $2}' >> /job_data/Result.log
done

cat /job_data/Result.log