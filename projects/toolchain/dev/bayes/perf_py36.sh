...
hdfs dfs -get hdfs://hobot-bigdata/user/kongtao.hu/horizon_algorithm_toolkit/python3.6/release_models.tgz
...
# update
cp projects/toolchain/dev/bayes/dev/Result_py36.LOG tmp_models/Result.LOG
...
hdfs dfs -rm -r hdfs://hobot-bigdata/user/kongtao.hu/horizon_algorithm_toolkit/python3.6/release_models.tgz
hdfs dfs -rm -r hdfs://hobot-bigdata/user/kongtao.hu/horizon_algorithm_toolkit/python3.6/release_hbms.tgz
hdfs dfs -copyFromLocal release_models.tgz hdfs://hobot-bigdata/user/kongtao.hu/horizon_algorithm_toolkit/python3.6/
hdfs dfs -copyFromLocal release_hbms.tgz hdfs://hobot-bigdata/user/kongtao.hu/horizon_algorithm_toolkit/python3.6/
# rm -rf release_models*
# rm -rf release_hbm*
