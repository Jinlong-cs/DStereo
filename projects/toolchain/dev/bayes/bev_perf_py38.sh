...
hdfs dfs -get hdfs://hobot-bigdata/user/kongtao.hu/horizon_algorithm_toolkit/python3.8/bev_release_models.tgz
...
hdfs dfs -rm hdfs://hobot-bigdata/user/kongtao.hu/horizon_algorithm_toolkit/python3.8/bev_release_models.tgz
hdfs dfs -copyFromLocal bev_release_models.tgz hdfs://hobot-bigdata/user/kongtao.hu/horizon_algorithm_toolkit/python3.8/
