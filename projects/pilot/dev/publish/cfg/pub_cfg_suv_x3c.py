...
# 本地编译模式相关参数
output_dir = f"tmp_compile_suv_x3c_{march}"  # 编译后模型存放目录
...
# 模型推理相关参数
infer_result_prefix = "infer_suv_x3c"

# 模型名称，编译后hbm模型整体的模型名称，aidi编译模式下 也是发版模型的名称
# notice suv-x3c include maxfa-x3c、ev52-x3c
publish_name = "MCP3.0-AlgoModel5V-OV-SUV"

desc = "MCP3.0-suv-x3c"  # 模型的描述
...
models["pilot_legorcnn_multitask_resize_2"].update(
    dict(
        model_setting="suv_x3c_day_lmdb",
        ...
        model_address="http://aidi.hobot.cc/user/homespace/jiaxi.wu/plat_gpu/hobot-dag-2100293_resize-2-training-ev52-x3c-day-lmdb/output/models/pilot_multitask_resize2/sparse_3d_freeze_bn_2-checkpoint-last-f52cd157.pth.tar",  # noqa
    )
)

models["pilot_legorcnn_multitask_resize_2_night"].update(
    dict(
        model_setting="suv_x3c_night_lmdb",
        input_shape="1x3x160x240^1x3x640x960",
        jobs_num=jobs_num,
        extra_args="--pyramid-stride ,960 -g --max-time-per-fc 1000",
        input_source="ddr,pyramid",
        ...
        model_address="http://aidi.hobot.cc/user/homespace/jiaxi.wu/plat_gpu/hobot-dag-2100293_resize-2-training-ev52-x3c-night-lmdb/output/models/pilot_multitask_resize2/sparse_3d_freeze_bn_2-checkpoint-last-06a6db06.pth.tar",  # noqa
    )
)
...
models["pilot_legorcnn_multitask_resize_4"].update(
    dict(
        ...
        model_address="http://aidi.hobot.cc/user/homespace/jiaxi.wu/plat_gpu/hobot-dag-2152954_pilot-multitask-resize4-ev52-x3c-day-lmdb-20230325-170033/output/models/pilot_multitask_resize4/sparse_3d_freeze_bn_2-checkpoint-last-cbea4488.pth.tar",  # noqa
    )
)
...
models["pilot_legorcnn_multitask_resize_4_night"].update(
    dict(
        ...
        model_address="http://aidi.hobot.cc/user/homespace/jiaxi.wu/plat_gpu/hobot-dag-2100571_resize-4-training-ev52-x3c-night-lmdb/output/models/pilot_multitask_resize4/sparse_3d_freeze_bn_2-checkpoint-last-b1e245a2.pth.tar",  # noqa
    )
)
