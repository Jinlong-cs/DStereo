...
# 本地编译模式相关参数
output_dir = f"tmp_compile_c385_x3c_{march}"  # 编译后模型存放目录
...
# 模型推理相关参数
infer_result_prefix = "infer_c385_x3c"

# 模型名称，编译后hbm模型整体的模型名称，aidi编译模式下 也是发版模型的名称
publish_name = "MCP3.0-AlgoModel5V-OV-C385"

desc = "MCP3.0-c385-x3c"  # 模型的描述
