...
# 本地编译模式相关参数
output_dir = f"tmp_compile_sedan_parking_x3c_{march}"  # 编译后模型存放目录
...
# 模型推理相关参数
infer_result_prefix = "infer_sedan_x3c_parking"

# 模型名称，编译后hbm模型整体的模型名称，aidi编译模式下 也是发版模型的名称
# notice sedan-parking-x3c include c385-parking-x3c
publish_name = "MCP3.0-AlgoModel5V-OV-sedan-Parking"

desc = "MCP3.0-sedan-parking-x3c"  # 模型的描述
...
models["pilot_legorcnn_multitask_resize_2_parking"].update(
    dict(
        model_setting="sedan_x3c_parking",
