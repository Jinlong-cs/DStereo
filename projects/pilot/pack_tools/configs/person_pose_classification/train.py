...
CLASS_NAMES = ["Bended", "Cyclist", "Lier", "Pedestrian", "Sitter"]
...
task_name = "person_pose_classification"

anno_ts_fn_config_path = f"configs/{task_name}/person_pose_config.yaml"  # noqa
