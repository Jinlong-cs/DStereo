...
name_prefix = "galaxy_algo"

# 软件包, 软件包管理平台软件包名
app = "Pilot5.0-202310121830-V6.3.1.zip"

# 软件包更新hbm文件, 支持：
# 1. bucket路径保存的hbm
# 2. aidi发版模型，通过 {name}:{version} 的形式来指定编译hbm，通常version为上一个版本
update_hbm = "MCP5.0_galaxy_x3c_pe:v18.0.6"
...
app_config = {
    "odo_type": "none",
    "app": {
        "6V/mono/adas-rt/config-eth/EmulationInputModule.json": {
            "use_pack_camera": 1
        }
    },
}
