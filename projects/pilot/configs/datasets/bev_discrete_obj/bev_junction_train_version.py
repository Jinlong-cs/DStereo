...
HDE_lidar_v1_1_9_small = {
    "BJ": {
        ...
        "UT263": {"0078_UT263_20221228_ml_66map": None},
        "UT1R3": {"0076_UT1R3_20221228_ml_70map": None},
        "UTHS6": {"0077_UTHS6_20221228_ml_66map": None},
        "UT3J5": {"0081_UT3J5_20221228_ml_96map": None},
    },
    "11v_driving_data_small": {
        "LX165": {"merge_LX165_det_v5a_20230226_20230301_LX165_11v": None},
        "UT263": {
            "merge_UT263_freespace_v5a_20221116_junction_ut126_ut263_11v": None,
            "merge_UT263_freespace_v5a_20221016_20221016_UT263_11v": None,
            "20221110_717586_1_FSD_Site_UT263_20221016": None,
            "merge_UT263_freespace_v5a_20221026_20221031_UT263_11v": None,
            "merge_UT263_freespace_v5a_20221025_20221025_UT263_11v": None,
            "merge_UT263_det_v5a_20221215_20221215_UT263_11v": None,
            "merge_UT263_det_v5a_20221217_20221221_UT263_val_11v": None,
            "merge_UT263_det_v5a_20221217_20221221_UT263_11v": None,
            "merge_UT263_det_v5a_20221223_20221224_UT263_11v": None,
        },
        "UT126": {
            "merge_UT126_freespace_v5a_20221116_junction_ut126_ut263_11v": None,
            "merge_UT126_freespace_v5a_20221016_20221030_UT126_11v": None,
            "merge_UT126_det_v5a_20221213_20221220_UT126_11v": None,
        },
        "UT1R3": {
            "merge_UT1R3_freespace_v5a_20221108_1109_UT1R3_11v": None,
            "merge_UT1R3_freespace_v5a_20221028_20221030_UT1R3_11v": None,
            "merge_UT1R3_det_v5a_20221213_20221215_UT1R3_11v": None,
            "merge_UT1R3_det_v5a_20221217_20221220_UT1R3_11v": None,
        },
        "UTHS6": {
            "merge_UTHS6_freespace_v5a_20221018_20221025_UTHS6_11v": None,
            "merge_UTHS6_freespace_v5a_20221024_20221026_UTHS6_11v": None,
            "merge_UTHS6_freespace_v5a_20221028_20221031_UTHS6_11v": None,
            "merge_UTHS6_freespace_v5a_20221101_20221108_UTHS6_11v": None,
            "20221111_718177_1_FSD_Site_UTHS6_20221101": None,
            "merge_UTHS6_det_v5a_20221213_20221215_UTHS6_11v": None,
        },
        "UT0Q9": {
            "20221110_717585_1_FSD_Site_UT0Q9_20221013": None,
            "merge_UT0Q9_freespace_v5a_20221010_20221020_UT0Q9_11v": None,
...
HDE_lidar_v1_1_9_wide = {
    ...
    "11v_driving_data_wide": {
        ...
        "UT263": {
            ...
            "merge_UT263_det_v5a_20221217_20221221_UT263_11v": None,
            "merge_UT263_det_v5a_20221223_20221224_UT263_11v": None,
            "merge_UT263_det_v5a_20221217_20221221_UT263_11v_v2": None,
        },
        "UT126": {
            "merge_UT126_freespace_v5a_20221116_junction_ut126_ut263_11v": None,
            "merge_UT126_freespace_v5a_20221016_20221030_UT126_11v": None,
            "merge_UT126_det_v5a_20221213_20221220_UT126_11v": None,
            "merge_UT126_det_v5a_20221213_20221220_UT126_11v_v2": None,
        },
        "UT1R3": {
            "merge_UT1R3_freespace_v5a_20221108_1109_UT1R3_11v": None,
            "merge_UT1R3_freespace_v5a_20221028_20221030_UT1R3_11v": None,
...
HDE_lidar_v1_2_0_small = del_item_in_dict(
    HDE_lidar_v1_1_9_small, v1_2_0_small_del
)
v1_2_0_small_update = {
    "11v_driving_data_small": {
        "LX165": {
...
# update data
HDE_lidar_v1_2_0_small = update_item_in_dict(
    HDE_lidar_v1_2_0_small, v1_2_0_small_update, only_use_update_version
)
...
HDE_lidar_v1_2_0_wide = del_item_in_dict(
    HDE_lidar_v1_1_9_wide, v1_2_0_wide_del
)
v1_2_0_wide_update = {
    "11v_driving_data_wide": {
        "LX165": {
...
# update data
HDE_lidar_v1_2_0_wide = update_item_in_dict(
    HDE_lidar_v1_2_0_wide, v1_2_0_wide_update, only_use_update_version
)
...
# update data
HDE_lidar_v1_2_1_small = update_item_in_dict(
    HDE_lidar_v1_2_0_small, v1_2_1_small_update, only_use_update_version
)
...
# update data
HDE_lidar_v1_2_1_wide = update_item_in_dict(
    HDE_lidar_v1_2_0_wide, v1_2_1_wide_update, only_use_update_version
)
...
v1_2_2_small_update = {
    "BJ": {
        "UT0Q9": {
            "merged__0_180__20221025": None,
            "merged__0_180__20221126_20221206": None,
            "merged__0_180__20221207_20230103": None,
            "merged__0_180__20230105_20230304": None,
            "merged__0_180__20230316_20230321": None,
        },
        "LS830": {
            "merged__0_180__20230303": None,
            "merged__0_180__20230322_20230330": None,
            "merged__0_180__20230322_20230330": None,
        },
        "NC110": {
            "merged__0_180__20221213_20221219": None,
            "merged__0_180__20221228_20230107": None,
            "merged__0_180__20230304_20230330": None,
            "merged__0_180__20230331_20230401": None,
        },
    },
    "11v_driving_data_small": {
        "LS830": {
...
# update data
HDE_lidar_v1_2_2_small = update_item_in_dict(
    HDE_lidar_v1_2_1_small, v1_2_2_small_update, only_use_update_version
)
...
HDE_lidar_v1_2_2_wide = del_item_in_dict(
    HDE_lidar_v1_2_1_wide, v1_2_2_wide_del
)
...
# update data
HDE_lidar_v1_2_2_wide = update_item_in_dict(
    HDE_lidar_v1_2_2_wide, v1_2_2_wide_update, only_use_update_version
)

# junction crosswalk merge data
v1_2_2_merge_wide_update = {
    "11v_driving_auto_show_wide_resample": {
        "UT1R3": {
            "20230220_738832_1_FSD_Site_UT1R3_20230204": None,
            "20230220_738832_1_FSD_Site_UT1R3_20230205": None,
    ...
    "11v_driving_background": {
        ...
        "UT0F3": {
            "merged__22_160__20221212_20221229": None,
        },
        "UT0Q9": {
            "merge_UT0Q9_det_v5a_20221217_20221218_UT0Q9_11v": None,
...
# update data
HDE_lidar_v1_2_2_wide_merge = update_item_in_dict(
    HDE_lidar_v1_2_2_wide, v1_2_2_merge_wide_update, only_use_update_version
)
...
# update data
HDE_lidar_v1_2_3_wide_merge = update_item_in_dict(
    HDE_lidar_v1_2_2_wide_merge, v1_2_3_wide_update, only_use_update_version
)

# del data which only contains crosswalk label
v1_2_4_wide_del = {
    "11v_driving_data_wide": {
        "UT263": {
            "20221018_711931_1_FSD_Site_UT263_20220925": None,
...
HDE_lidar_v1_2_4_wide_merge = del_item_in_dict(
    HDE_lidar_v1_2_3_wide_merge, v1_2_4_wide_del
)
v1_2_4_wide_update = {
    "11v_driving_data_wide": {
        "UT263": {
...
# update data
HDE_lidar_v1_2_4_wide_merge = update_item_in_dict(
    HDE_lidar_v1_2_4_wide_merge, v1_2_4_wide_update, only_use_update_version
)
...
temporal_v1_1_0_wide_merge_update = {
    "11v_driving_data_wide_temporal": {
        "UT263": {"merge_UT263_det_v5a_20230112_20230114_UT263_11v": None}
    }
}
temporal_v1_1_0_wide_merge = update_item_in_dict(
    temporal_v1_1_0_wide,
    temporal_v1_1_0_wide_merge_update,
    only_use_update_version,
)
...
# update data
temporal_v1_2_0_wide_merge = update_item_in_dict(
    temporal_v1_1_0_wide_merge,
    temporal_v1_2_0_wide_update,
    only_use_update_version,
)
...
# update data
temporal_v1_3_0_wide_merge = update_item_in_dict(
    temporal_v1_2_0_wide_merge,
    temporal_v1_3_0_wide_update,
    only_use_update_version,
)
...
crossroad_wt_crosswalk_trainset_v1_0_0_wide_merge_junction_crosswalk = {
    "byd_7v_driving_data_wide": {
        "BYD19": {
...
crossroad_wo_crosswalk_trainset_v1_0_0_wide_merge_junction_crosswalk = {
    "byd_7v_driving_data_wide": {
        "BYD19": {
            "crossroad_wo_crosswalk_trainset_merge_BYD19_20230531_20230531_single_posefilter_1p0": None,
            "crossroad_wo_crosswalk_trainset_merge_BYD19_20230605_20230611_single_posefilter_1p0": None,
        },
    },
    "11v_driving_data_wide": {
        "LS830": {
        ...
        "UT0Q9": {
            "crossroad_wo_crosswalk_trainset_merge_UT0Q9_20230423_20230423_single_posefilter_1p0": None,
...
junction_trainset_v1_0_0_wide_merge_junction_crosswalk = {
    "byd_7v_driving_data_wide": {
        "BYD19": {
...
junction_crossroad_trainset_v1_0_0_merge_junction_crosswalk_tmp = (
    update_item_in_dict(
        junction_trainset_v1_0_0_wide_merge_junction_crosswalk,
        crossroad_wt_crosswalk_trainset_v1_0_0_wide_merge_junction_crosswalk,
        only_use_update_version,
...
junction_crossroad_trainset_v1_0_0_merge_junction_crosswalk = (
    update_item_in_dict(
        junction_crossroad_trainset_v1_0_0_merge_junction_crosswalk_tmp,
        crossroad_wo_crosswalk_trainset_v1_0_0_wide_merge_junction_crosswalk,
        only_use_update_version,
...
HDE_lidar_v1_2_4_wide_merge = reduce_sample_interval(
    HDE_lidar_v1_2_4_wide_merge, scale=4, ignore_tags=None
)
# update data
HDE_lidar_v1_3_0_wide_merge_junction_crosswalk = update_item_in_dict(
    HDE_lidar_v1_2_4_wide_merge,
    junction_crossroad_trainset_v1_0_0_merge_junction_crosswalk,
    only_use_update_version,
)
