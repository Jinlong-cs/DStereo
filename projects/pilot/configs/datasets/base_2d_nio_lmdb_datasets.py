...
def append_data_not_exists_in_niofy(
...
niofy_datapaths = {
    ...
    "vehicle": {
        "train_data_paths": [
            ...
            # galaxy JIRA-badcase-hard 676
            {
                "data_path": f"{root}/multicam_pilot/data/lmdb_datasets/multicam_pilot/data/train/vehicle_detection/pilot_vehicle_5v_CAMERA_GALAXY_JIRA-badcase_hard_all/20230523-203558",
                "sample_weight": 6,
                "partition": "jira",
            },
            # galaxy 白天 异型车 3863
...
niofy_datapaths = EasyDict(niofy_datapaths)
append_data_not_exists_in_niofy(
    input_datapaths=pilot3_day_datapaths,
    output_datapaths=niofy_datapaths,
