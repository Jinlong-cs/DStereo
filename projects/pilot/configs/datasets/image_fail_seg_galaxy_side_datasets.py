...
datapaths = dict(
    image_fail_parsing=dict(
        ...
        train_data_paths=[
            ...
            # ## galaxy
            # dict(
            #     rec_path=f'{tmp_root}/multicam_pilot/data/train/image_fail/blur/20220727_030812/train_X3C-OFT224_blur_cls7_day_num709_20220727_030812.rec',  # noqa
            #     anno_path=f'{tmp_root}/multicam_pilot/data/train/image_fail/blur/20220727_030812/train_X3C-OFT224_blur_cls7_day_num709_20220727_030812.json',  # noqa
            #     sample_weight=1,
            # ),
            # dict(
            #     rec_path=f'{tmp_root}/multicam_pilot/data/train/image_fail/blur/20220727_030958/train_X3C-OFT224_blur_cls7_night_num574_20220727_030958.rec',  # noqa
            #     anno_path=f'{tmp_root}/multicam_pilot/data/train/image_fail/blur/20220727_030958/train_X3C-OFT224_blur_cls7_night_num574_20220727_030958.json',  # noqa
            #     sample_weight=1,
            # ),
            # dict(
            #     rec_path=f'{tmp_root}/multicam_pilot/data/train/image_fail/blur/20220727_031208/train_X3C-OFT224_blur_cls7_day_num859_20220727_031208.rec',  # noqa
            #     anno_path=f'{tmp_root}/multicam_pilot/data/train/image_fail/blur/20220727_031208/train_X3C-OFT224_blur_cls7_day_num859_20220727_031208.json',  # noqa
            #     sample_weight=1,
            # ),
            # dict(
            #     rec_path=f'{tmp_root}/multicam_pilot/data/train/image_fail/blur/20220727_031458/train_X3C-OFT224_blur_cls7_day_num984_20220727_031458.rec',  # noqa
            #     anno_path=f'{tmp_root}/multicam_pilot/data/train/image_fail/blur/20220727_031458/train_X3C-OFT224_blur_cls7_day_num984_20220727_031458.json',  # noqa
            #     sample_weight=2,
            # ),
            # dict(
            #     rec_path=f'{tmp_root}/multicam_pilot/data/train/image_fail/blur/20220727_031619/train_X3C-OFT224_blur_cls7_day_num56_20220727_031619.rec',  # noqa
            #     anno_path=f'{tmp_root}/multicam_pilot/data/train/image_fail/blur/20220727_031619/train_X3C-OFT224_blur_cls7_day_num56_20220727_031619.json',  # noqa
            #     sample_weight=1,
            # ),
            # dict(
            #     rec_path=f'{tmp_root}/multicam_pilot/data/train/image_fail/blur/20220727_033132/train_X3C-OFT224_blur_cls7_night_num8995_20220727_033132.rec',  # noqa
            #     anno_path=f'{tmp_root}/multicam_pilot/data/train/image_fail/blur/20220727_033132/train_X3C-OFT224_blur_cls7_night_num8995_20220727_033132.json',  # noqa
            #     sample_weight=14,
            # ),
            # dict(
            #     rec_path=f'{root}/multicam_pilot/data/train/image_fail/blockage/20220629_144219/train_X3C-OFT224_blockage_cls7_day_num96_20220629_144219.rec',  # noqa
            ...
            # ),
            # dict(
            #     rec_path=f'{root}/multicam_pilot/data/train/image_fail/blockage/20220620_041206/train_ar0233-WISSEN_blockage_cls7_night_num1507_20220620_041206.rec',  # noqa
            #     anno_path=f'{root}/multicam_pilot/data/train/image_fail/blockage/20220620_041206/train_ar0233-WISSEN_blockage_cls7_night_num1507_20220620_041206.json',  # noqa
            #     sample_weight=2,
            # ),
            # dict(
            #     rec_path=f'{root}/multicam_pilot/data/train/image_fail/glare/20220629_143232/train_CW_A23GB_A114_L_num221_glare_cls7_night_20220629_143232.rec',  # noqa
            ...
            # ),
            # dict(
            #     rec_path=f'{root}/multicam_pilot/data/train/image_fail/glare/20220620_043345/train_ar0233-RGGB_glare_cls7_night_num578_20220620_043345.rec',  # noqa
            #     anno_path=f'{root}/multicam_pilot/data/train/image_fail/glare/20220620_043345/train_ar0233-RGGB_glare_cls7_night_num578_20220620_043345.json',  # noqa
            #     sample_weight=1,
            # ),
            # galaxy
            # blur
