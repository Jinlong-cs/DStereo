...
from projects.pilot.configs.bev_7v.base import remove_none
from projects.pilot.configs.bev_7v.common import model_thresh  # noqa
...
arrow_eval_vcs_range = (-32.0, -8.0, 52.8, 8.0)
...
# junction and crosswalk merge
vis_merge_crosswalk_to_junction = True
