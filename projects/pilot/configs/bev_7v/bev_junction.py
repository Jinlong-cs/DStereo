...
# -------------------------- data --------------------------
train_data_version = "HDE_lidar_v1_3_0_wide_merge_junction_crosswalk"
# Note: following testsets are (1) SD-testset, (2) junction, (3) crossroad with crosswalk, (4) crossroad without crosswalk  # noqa
# val_data_version = [
#     "HDE-lidar_v1.1.5_wide",
#     "HDE-lidar_v1.1.5_wide_crosswalk",
# ]
val_data_version = "junction_testset_v1.0.0_wide_merge_junction_crosswalk"
# val_data_version = "crossroad_wt_crosswalk_testset_v1.0.0_wide_merge_junction_crosswalk"
# val_data_version = "crossroad_wo_crosswalk_testset_v1.0.0_wide_merge_junction_crosswalk"
...
task_loss_weight = 0.02
task_attr_loss_weight = {
    "bev_hm": 2.0,
    "bev_dim": 1.0,
    "bev_ct_offset": 1.0,
    "bev_rot": 4.0,
...
# # The following logic is abandoned because junction and crosswalk are now merged in one testset  # noqa
# if merge_crosswalk_to_junction and not pipeline_test:
