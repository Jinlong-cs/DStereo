...
from projects.pilot.configs.bev_7v_temporal.online_mapping import (
    in_stride,
    out_size,
    roi_vcs_range,
)
...
deploy_conf_thresh = {"crosspoints": 0.4, "changepoints": 0.45}
target_categorys = {
    "merge_start": 0,
    "merge_stop": 1,
    "split_start": 2,
...
crosspoint_target_size = (
    head_out_size[0] * cpts_stride,
    head_out_size[1] * cpts_stride,
)
