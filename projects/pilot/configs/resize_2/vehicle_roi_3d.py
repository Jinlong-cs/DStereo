...
if with_angle_augmentation:
    ...
    mask_image_edge_transform = dict(
        ...
        mask_ranges=((0, 100), (0, 100), (860, 960), (540, 640)),
        seed=0,
        prob=0.5,
    )
...
if lmdb_data:
    ...
    val_data_loader["shuffle"] = False
    for datasets in val_data_loader["dataset"]["datasets"]:
        for dataset in datasets["datasets"]:
            dataset["transforms"][-1]["is_train"] = False
