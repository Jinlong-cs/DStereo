...
if "test" in model_setting:
    pretrain_checkpoint = "http://fm-feng01-wang.train.hogpu.cc/plat_gpu/pilot_multitask_resize2_c385_x3c_day_v6.0-20230201_202340/output/models/pilot_multitask_resize2/with_bn-checkpoint-last.pth.tar"  # noqa
