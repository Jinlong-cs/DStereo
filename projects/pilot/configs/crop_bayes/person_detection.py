...
roi_feat_extractor = dict(
    ...
    canonical_level=5,
    aligned=None,
    node_name="person_roi_feat_extractor",
)
...
roi_head = dict(
    ...
    upscale=False,
    node_name="person_roi_share_head",
)
...
def get_model(mode):
    ...
    return dict(
        ...
        rpn_module=dict(
            ...
            target=dict(
                node_name="person_anchor_target",
                    ...
                    transforms=[
                        ...
                        dict(
                            ...
                            transforms=[
                                ...
                                dict(
                                    type="IterableDetRoIListTransform",
                                    # roi list transform
                                    target_wh=input_hw[::-1],
                                    resize_wh=None,  # noqa
                                    img_scale_range=rand_crop_scale_range,
