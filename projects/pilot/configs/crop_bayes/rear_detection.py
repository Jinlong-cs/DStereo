...
task_type = "detection"
vis_tasks.append("rear")

classnames = ["vehicle_rear"]
...
anchor_args = dict(
    ...
    anchor_wh_groups=[
        [[8, 8], [16, 16], [18, 20], [24, 24], [35, 15]],
        [[25, 32], [38, 45], [49, 51], [60, 24], [64, 64]],
        [
            [85, 105],
            [96, 96],
            [114, 118],
...
roi_feat_extractor = dict(
    ...
    canonical_level=5,
    aligned=None,
    node_name="rear_roi_feat_extractor",
)
