...
from models import march, model, test_model, traced_inputs  # noqa
...
# step-specific args
num_steps = int(num_steps[training_step] // batch_size_factor)
...
# clipping: begin
pretrain_checkpoint = "http://fm-wenyuan-zeng.bcloud-2nd.hogpu.cc/plat_gpu/hobot-dag-2539516_crop-bayes-training-galaxy-0233-rear-day-lmdb/output/models/pilot5_multitask_crop_bayes/with_bn-checkpoint-last-f695e81b.pth.tar"  # noqa
