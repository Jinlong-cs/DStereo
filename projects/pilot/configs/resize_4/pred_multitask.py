...
data_loader = dict(
    ...
    dataset=dict(
        type="YUVFrames",
        img_dir=f"{HAT_BUCKET_PATH}/users/tian.li/consistency/{model_setting}/resize_4",
        calib_path=f"{HAT_BUCKET_PATH}/users/tian.li/consistency/{model_setting}/resize_4.json",
        im_hw=input_hw,
    ),
    batch_size=1,
    shuffle=False,
