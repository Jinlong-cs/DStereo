...
if "test" in model_setting:
    pretrain_checkpoint = "http://svcspawner.bcloud-2nd.hobot.cc/user/homespace/jiaxi.wu/plat_gpu/hobot-dag-3047636_resize-4-training-ev52-x3c-day-lmdb/output/models/pilot_multitask_resize4/with_bn-checkpoint-last-f93980c5.pth.tar"
