...
def update_embedding_state_dict(state_dict):
    key_mapping = [
        ...
        (
            "vehicle_wheel_kps_roi_share_head",
            "vehicle_wheel_detection_roi_share_head",
        ),
    ]
...
# clipping: begin
pretrain_checkpoint = "http://fm-wentao-xie.bcloud-2nd.hogpu.cc/plat_gpu/hobot-dag-3335047_resize-2-side-bayes-training-galaxy-x3c-side-lmdb/output/models/pilot5_multitask_resize2_side_bayes/with_bn-checkpoint-last-a21870e5.pth.tar"  # noqa
