...
from schedule import train_stages_random_seeds
    ...
    for pred in preds:
        ...
        pred_bboxes.append(
            torch.cat(
                [
                    det_pred.boxes,
                    det_pred.cls_idxs[:, None],
                    det_pred.scores[:, None],
                ],
                dim=1,
            )
        )
...
if lmdb_data:
    ...
    data_loader = dict(
        ...
        dataset=dict(
            ...
            seed=train_stages_random_seeds.get(training_step, 0),
            datasets=[
                dict(
