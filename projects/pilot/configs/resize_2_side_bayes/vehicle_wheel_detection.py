...
max_subbox_num = 10
subbox_score_thresh = (
    model_thresh["roi_det_thresh"][object_type] if model_thresh else 0.1
)
feature_h = 16
feature_w = 16
    ...
    roi_model = dict(
        ...
        head=dict(
            ...
            modules=[
                dict(
                    ...
                    stride=1,
                    upscale=True,
                    node_name=f"{task_name}_roi_share_head",
                ),
                dict(
                ...
                [
                    dict(
                        ...
                        per_tensor_desc=frcnn_veh_wheel_detection_desc(
                            ...
                            label_output_name="vehicle_wheel_detection_label",  # noqa
                            offset_output_name="vehicle_wheel_detection_offset",  # noqa
                            subbox_score_thresh=subbox_score_thresh,
                            max_subbox_num=max_subbox_num,
                            roi_w_expand_scale=roi_args["roi_wh_zoom_scale"][
                                0
                            ],
                            roi_h_expand_scale=roi_args["roi_wh_zoom_scale"][
                                1
                            ],
                        ),
        ...
        target=dict(
            ...
            label_encoder=dict(
                ...
                reg_on_hard=True,
                use_ig_region=True,
                roi_w_zoom_scale=roi_args["roi_wh_zoom_scale"][0],
                roi_h_zoom_scale=roi_args["roi_wh_zoom_scale"][1],
            ),
        ...
        postprocess=dict(
            type="HeatmapMultiBox2dDecoder",
            max_box_num=max_subbox_num,
            subbox_score_thresh=subbox_score_thresh,
            nms_iou_thresh=0.01,
            legacy_bbox=data_args["legacy_bbox"],
            roi_wh_zoom_scale=roi_args["roi_wh_zoom_scale"],
        ...
        dataset=dict(
            ...
            datasets=[
                dict(
                    ...
                    transforms=[
                        dict(
                            type="DetSeg2DAnnoDatasetToRoiMultiDetectionFormat",  # noqa
        ...
        dataset=dict(
            ...
            datasets=[
                dict(
                    ...
                    transforms=[
                        dict(
                            type="DetSeg2DAnnoDatasetToRoiMultiDetectionFormat",
                            selected_class_ids=classname2idxs,
                            lt_point_id=10,
                            rb_point_id=12,
                            parent_lt_point_id=0,
