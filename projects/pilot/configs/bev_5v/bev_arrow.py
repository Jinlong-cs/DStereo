...
# -------------------------- data --------------------------
train_data_version = "HDE_lidar_v1_2_11_small"
val_data_version = "HDE-lidar_v2.2.5_small"
...
if arrow_head_with_cls:
    ...
    loss_weights = {
        "bev_discobj_hm": 1.0,
        "bev_discobj_hm_cls": 1.0,
        "bev_discobj_hm_cls_aux": 1.0,
        "bev_discobj_wh": 1.0,
...
def get_model(mode):
    bev_head = dict(
        ...
        postprocess=None,
        target=None,
        node_name="bev_stage2_arrow_small_head",
    )
    if mode == "train":
        bev_head["loss"] = dict(
