...
from projects.pilot.configs.bev_5v.bev_static_obstacle import (
    task_val_metric_setting as cementcolumn_metric_setting,
)
...
# -------------------------- data --------------------------
train_data_version = "v1_6_0"
val_data_version = "v1.2.0"
...
task_val_metric_setting = copy.deepcopy(cementcolumn_metric_setting)
