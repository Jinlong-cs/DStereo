...
from projects.pilot.configs.bev_5v.bev_static_obstacle import (
    task_val_metric_setting as parkinglock_metric_setting,
)
...
dataset_name = "bev_static_obstacle"
...
task_val_metric_setting = copy.deepcopy(parkinglock_metric_setting)

for update_key, update_value in model_thresh.get(dataset_name, {}).items():
...
visualize_callbacks = [
    dict(
        ...
        output_dir=os.path.join(save_prefix, "visualize", "bev_parkinglock"),
        task="bev_parkinglock",
        ...
        camera_layouts=None,
        res_key2anno_name={
            "bev_parkinglock": "annos_bev_discrete_obj",
        },
        color_map=COLOR_MAP,
        id2label=ID2LABEL,
        visual_interval=1,
