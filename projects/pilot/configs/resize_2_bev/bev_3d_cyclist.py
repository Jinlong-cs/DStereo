...
def get_model(mode):
    bev_stage2_out_module = dict(
        ...
        postprocess=None,
        target=None,
        node_name="bev_stage2_3d_cyclist_head",
    )
    ...
    if mode == "val":
        ...
        bev_stage2_out_module["postprocess"] = dict(
            ...
            nms_thresh=0.5,
            center_offset=True,
            node_name="bev_stage2_3d_cyclist_decoder",
        )
    if mode == "test":
...
if num_classes == 1:
    ...
    task_cls_label_desc = ["motor_cyclist", "bicycle_cyclist"]
else:
...
def get_bev_desc():
    per_tensor_desc = [
        {
            "task": "bev_3d_cyclist",
            "output_name": "bev_3d_cyclist_heatmap_output",
        ...
        {
            "task": "bev_3d_cyclist",
            "output_name": "bev_3d_cyclist_dimension_output",
        ...
        {
            "task": "bev_3d_cyclist",
            "output_name": "bev_3d_cyclist_rot_output",
            "properties": [{"channel_labels": ["cos", "sin"]}],
            **bev_common_desc,
        },
        {
            "task": "bev_3d_cyclist",
            "output_name": "bev_3d_cyclist_ct_offset_output",
            "properties": [{"channel_labels": ["offset_x", "offset_y"]}],
            **bev_common_desc,
        },
        {
            "task": "bev_3d_cyclist",
            "output_name": "bev_3d_cyclist_loc_z_output",
