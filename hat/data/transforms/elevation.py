...
class ToTensorElevation(object):
    ...
    Args:
        ...
        use_yuv_v2: use BgrToYuv444V2 when convert img to yuv format.
    ...
    def __init__(
        ...
        if use_yuv_v2:
            yuv_converter = BgrToYuv444V2(True)
        else:
            yuv_converter = BgrToYuv444(True)
        self.pil2yuv = torchvision.transforms.Compose(
            [torchvision.transforms.PILToTensor(), yuv_converter]
        )
