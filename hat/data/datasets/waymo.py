...
class WaymoDataset(Dataset):
    ...
    def __init__(
        ...
        Args:
            info_path: path to annotation file.
            root_path: root path ot data.
            transforms (Compose, optional): A transform Compose object.
                Defaults to None.
            class_names (List[str], optional): A list of category names.
                Defaults to None.
            test_mode: whether in test. Defaults to False.
            nsweeps: number of sweeps of lidar points.
                Defaults to 1.
            load_interval: jump this many samples when
    ...
    def load_waymo_single_frame(frame_path: str) -> np.ndarray:
        ...
        Args:
            frame_path: path to the point cloud file.

        Returns:
            an N x 5 array containing all points.
        """
    ...
    def load_waymo_single_sweep(self, sweep: Dict[str, Any]) -> np.ndarray:
        ...
        Returns:
            an N x 5 array containing all points of that sweep.
        """
...
@require_packages(
    "waymo_open_dataset",
    raise_msg="Please `pip3 install waymo-open-dataset-tf-2-4-0`",
)
def _create_pd_detection(
    ...
    Args:
        ...
        root_path: root path where data info is stored.
        result_path: path to write file to.
        simple_infer: whether the results are in simple
            formats. Determines how detections will be interpreted.
            Defaults to False.
        threshold: Detection threshold. Defaults to 0.15.
        tracking: Whether this is tracking results.
            Defaults to False.
        write_file: whether to write final detections to disk. False is
