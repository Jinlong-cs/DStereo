...
class PSDTestSlotDataset(data.Dataset):
    ...
    Args:
        path: The path of dataset file.
        input_size: The size of input images.
        pack_type: The file type for packing.
        transforms: Transforms of psd dataset before using.
    """

    def __init__(
        self,
        path: str,
        input_size: Optional[List] = (896, 896),
    ...
    def __setstate__(self, state):
        ...
        self.pack_file.open()
        self.num_samples = len(self.pack_file) // 2
...
class PSDSlotDataset(data.Dataset):
    ...
    def __init__(
        self,
        path: str,
        input_size: Optional[List] = (448, 448),
        pack_type: Optional[str] = None,
        transforms: Optional[List] = None,
    ):
        self.path = path
    ...
    def __setstate__(self, state):
        ...
        logging.info(f"psd dataset path: {self.path}")
        logging.info(f"psd dataset length: {self.num_samples}")
