...
"""AVSPEECH(多模语音)Tendis接口模块.

目前该模块下共有一个类、一个函数:

TendisClient : Tendis接口类.

multimodal_default_rename_handle : 默认的 key 重命名接口.
"""
...
class TendisClient(Redis):
    ...
    @require_packages("redis>4.0")
    def __init__(
        self,
        rename_handle: Optional[Callable[[str], str]] = None,
