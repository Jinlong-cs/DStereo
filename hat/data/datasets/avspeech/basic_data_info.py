...
"""AVSPEECH(多模语音)基础标签信息模块.

目前该模块下共有两个类:

BasicDataInfo         : 基础标签信息类.
TendisBasicInfoReader : Tendis读取标签信息并返回标签信息对象.
"""
...
class BasicDataInfo(object):
    ...
    多模数据的基础标签信息, json标签抽象类. 详细的json结构参见:
    https://horizonrobotics.feishu.cn/docs/doccnbQQKqDwQMFC1xXKGDdoqfg
...
class TendisBasicInfoReader(object):
    ...
    从tendis读取标签信息对应的一行json字符串, 并转换成基础BasicDataInfo返回.

    Args:
        tendis_kwargs: Tendis 数据库相关信息.
    """
