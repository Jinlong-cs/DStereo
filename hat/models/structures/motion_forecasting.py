...
__all__ = ["MotionForecasting", "MotionForecastingHbirInfer"]
...
@OBJECT_REGISTRY.register
class MotionForecastingHbirInfer(BaseHbirModule):
    """
    ...
    def forward(self, data):
        ...
        outputs = super().forward(
            (traj_feat, lane_feat, instance_mask, goals, goals_2d_mask)
        )
