...
__all__ = ["Detr3d", "Detr3dHbirInfer"]
...
@OBJECT_REGISTRY.register
class Detr3dHbirInfer(BaseHbirModule):
    """
    ...
    def __init__(
        ...
        super(Detr3dHbirInfer, self).__init__(model_path=model_path)
    ...
    def forward(self, data):
        ...
        outputs = super().forward((image, meta))
