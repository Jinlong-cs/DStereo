# This file if copied from https://github.com/HRNet/HRNet-Facial-Landmark-Detection/blob/master/lib/models/hrnet.py  # noqa
import logging
import os
...
class HRNet(nn.Module):
    """High Resolution Network V2.

    A classical network structure for human pose estimation. Widely used in
    keypoints detection related tasks.
    HRNet: `Deep High-Resolution Representation Learning for Human Pose Estimation`  # noqa
    Code: https://github.com/HRNet/HRNet-Human-Pose-Estimation

    HRNetV2: `High-Resolution Representations for Labeling Pixels and Regions`  # noqa
    TPAMI Version: `Deep High-Resolution Representation Learning for Visual Recognition`  # noqa
    Code: https://github.com/HRNet/HRNet-Facial-Landmark-Detection
    """

    def __init__(self, config: dict, include_head: bool = False, **kwargs):
        self.inplanes = 64
        extra = config["EXTRA"]
        ...
        if self.include_head:
            final_conv_kernel = kwargs("final_conv_kernel", 1)
