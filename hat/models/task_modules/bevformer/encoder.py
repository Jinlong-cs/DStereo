...
class BEVFormerEncoder(nn.Module):
    ...
    Args:
        ...
        use_cams_embeds: Wheather to use camera embeds.
    ...
    def init_weights(self):
        ...
        for m in self.modules():
            if (
                ...
                or isinstance(m, HorizonMSDeformableAttention3D)
                or isinstance(m, HorizonTemporalSelfAttention)
                or isinstance(m, HorizonMSDeformableAttention)
            ):
                m.init_weights()
