...
from hat.models.base_modules.target import ReshapeTarget
from hat.registry import OBJECT_REGISTRY
from hat.utils.apply_func import _as_list
from .spatial_fusion import SpatialTransfomer

__all__ = ["ANCBEVTarget"]


@OBJECT_REGISTRY.register
class ANCBEVTarget(nn.Module):
    ...
    def __init__(
        ...
        super(ANCBEVTarget, self).__init__()
