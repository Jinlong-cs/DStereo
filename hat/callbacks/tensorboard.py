...
# TODO(wenming.meng ?) support recording metric in tensorboard.
...
class TensorBoard(CallbackMixin):  # noqa: D205,D400
    ...
    Args:
        save_dir: Directory to save tensorboard.
        overwrite: Whether overwriting existed save_dir.
        loss_name_reg: Specific loss pattern.
        update_freq: Freq of tensorboard whether to output to file.
        update_by: Set `update_freq` unit to step or epoch.
            Default is step.
        tb_update_funcs: list of function with
    ...
    def on_step_end(self, **kwargs):
        ...
        #         #     self.writer.add_scalar(k, "%.4f" % v, global_step=kwargs['global_step_id'])
        #         # else:
        #         self.writer.add_scalar(k, v, global_step=kwargs['global_step_id'])
        # print("on_step_end done")
