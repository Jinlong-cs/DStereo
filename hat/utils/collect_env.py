...
def collect_env_info():
    ...
    Returns:
        dict: The environment information. The following fields are contained.
            ...
            - Horizon_Plugin_Pytorch: Horizon_plugin_pytorch verison.
            - HAT: HAT version.
            ...
            - HAT requirements info: Require libraries version.
    ...
    if torchaudio is not None:
        data.append(
            (
                ...
                + " @"
                + os.path.dirname(torchaudio.__file__),
            )
        )
    ...
    try:
        ...
        data.append(
            (
                "HAT",
                str(hat.__version__) + " @" + os.path.dirname(hat.__file__),
            )
        )
    except ImportError:
        data.append(("HAT", "failed to import"))
    except AttributeError:
        data.append(("HAT", "imported a wrong installation"))
