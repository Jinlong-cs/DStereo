...
def compare_version(
    ...
    if return_version:
        return op(pkg_version, Version(version)), pkg_version
    else:
...
def require_packages(
    *package_versions: str,
    ...
    def decorator(func) -> Callable:
        # TODO(mengyang.duan): fix @functools.wraps in sphinx
        # Note: there is error in building doc when use @functools.wraps
