...
from hat.core.nlu.nlu_utils import get_entities
...
def precision_score(y_true, y_pred, average="micro", suffix=False):
    ...
    intuitively the ability of the classifier
     not to label as positive a sample.
...
def classification_report(y_true, y_pred, digits=2, suffix=False):
    ...
    Returns:
        report : string. Text summary of the precision, recall,
    ...
    d1_list.sort()  # Fix order of all entities
    ...
    if len(s) == 0:
        report = "Can not find entity in label sequence, return empty report!"
        return report
